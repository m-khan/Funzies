...
public EquipKnife(any:client)
{
	...
	{
		PrintToChat(client, "\x01Your \x03Special Knife\x01 is available. Type '!knifemenu' to select a knife.");				
	}
	else
	{
		PrintToChat(client, "\x01Your \x03Special Knife\x01 will be equiped next spawn.");				
	}
}
