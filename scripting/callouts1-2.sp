...
public OnPluginStart() 
{
	...
	HookEvent("server_cvar", Event_DeadtalkChangeCvar, EventHookMode_Pre);
	HookEvent("round_end", Event_RoundEnd);
	HookConVarChange(g_Cvar_Enabled, OnEnableChanged)

}

public Action:Event_DeadtalkChangeCvar(Handle:event, const String:name[], bool:dontBroadcast) {  
	//This will keep all server cvar changes from being broadcasted to chat. (Specifically sv_deadtalk, but the effect isn't undesired other places)  
